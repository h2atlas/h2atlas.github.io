...
title: Ever felt worried, tense, or anxious for most of a month or longer - 20421
type: phenotype
weight: 2
---
...
table_select <- t(subset(table,phenotype=='20421'))
library(DT)
...
")
htmltools::includeHTML('../../plot_data/phenotype_par_pie_20421_script')
htmltools::includeHTML('../../plot_data/phenotype_par_pie_20421_div')
htmltools::HTML('</div>')
...
"You can hover your mouse on each segment and read information of it! If you want to examine segments of small size, you can zoom the figure using magnifying glass on the right toolbar. Making use of other additional functions (pan, reset, save, etc.) would help you deal with data conveniently
")
htmltools::includeHTML('../../plot_data/phenotype_corr_rank_20421_script')
htmltools::includeHTML('../../plot_data/phenotype_corr_rank_20421_div')
htmltools::HTML('</div>')
...
")
htmltools::includeHTML('../../plot_data/phenotype_anova_phenoype_20421_script')
htmltools::includeHTML('../../plot_data/phenotype_anova_phenoype_20421_div')
htmltools::HTML('</div>')
