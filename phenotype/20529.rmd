...
title: Victim of physically violent crime - 20529
type: phenotype
weight: 2
---
...
table_select <- t(subset(table,phenotype=='20529'))
library(DT)
...
")
htmltools::includeHTML('../../plot_data/phenotype_par_pie_20529_script')
htmltools::includeHTML('../../plot_data/phenotype_par_pie_20529_div')
htmltools::HTML('</div>')
...
"You can hover your mouse on each segment and read information of it! If you want to examine segments of small size, you can zoom the figure using magnifying glass on the right toolbar. Making use of other additional functions (pan, reset, save, etc.) would help you deal with data conveniently
")
htmltools::includeHTML('../../plot_data/phenotype_corr_rank_20529_script')
htmltools::includeHTML('../../plot_data/phenotype_corr_rank_20529_div')
htmltools::HTML('</div>')
...
")
htmltools::includeHTML('../../plot_data/phenotype_anova_phenoype_20529_script')
htmltools::includeHTML('../../plot_data/phenotype_anova_phenoype_20529_div')
htmltools::HTML('</div>')
