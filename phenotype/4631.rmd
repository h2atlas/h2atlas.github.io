...
title: Ever unenthusiastic/disinterested for a whole week - 4631
type: phenotype
weight: 2
---
...
table_select <- t(subset(table,phenotype=='4631'))
library(DT)
...
")
htmltools::includeHTML('../../plot_data/phenotype_par_pie_4631_script')
htmltools::includeHTML('../../plot_data/phenotype_par_pie_4631_div')
htmltools::HTML('</div>')
...
"You can hover your mouse on each segment and read information of it! If you want to examine segments of small size, you can zoom the figure using magnifying glass on the right toolbar. Making use of other additional functions (pan, reset, save, etc.) would help you deal with data conveniently
")
htmltools::includeHTML('../../plot_data/phenotype_corr_rank_4631_script')
htmltools::includeHTML('../../plot_data/phenotype_corr_rank_4631_div')
htmltools::HTML('</div>')
...
")
htmltools::includeHTML('../../plot_data/phenotype_anova_phenoype_4631_script')
htmltools::includeHTML('../../plot_data/phenotype_anova_phenoype_4631_div')
htmltools::HTML('</div>')
